        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h4><i class="fas fa-plus-circle me-2"></i>Adicionar Novo Filme</h4>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('movies.store') }}">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('year') is-invalid @enderror" 
                                           id="year" name="year" value="{{ old('year') }}" min="1900" max="{{ date('Y') + 2 }}" required>
                                    @error('year')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('genre') is-invalid @enderror" 
                                   ...
                                   placeholder="Ex: Drama, Ação, Comédia..." required>
                            @error('genre')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
